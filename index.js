...
app.use(express.urlencoded({extended:truc}));
...
const payload = {_id: req.user._id, email: req.user.email,accessToken:req.user.accessTc
jwt.sign(payload, process.env.JNT_SECRET, { expiresIn: "1h" }, (err, token) => {
if (err) throw err;
